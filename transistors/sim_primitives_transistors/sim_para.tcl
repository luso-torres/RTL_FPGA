...
set ::bali::simulation::Para(PROJECT) {sim_primitives_transistors}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/transistors}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/transistors/transistors.v" "D:/RTL_FPGA/transistors/primitives_ex.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {transistors}
