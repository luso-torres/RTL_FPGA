...
set ::bali::Para(MODNAME) not_switch
...
set ::bali::Para(OUTNAME) not_switch_tf
set ::bali::Para(EXT) .v
set ::bali::Para(FILELIST) {"D:/RTL_FPGA/transistors/transistors.v=work,Verilog_2001" "D:/RTL_FPGA/transistors/primitives_ex.v=work,Verilog_2001" }
