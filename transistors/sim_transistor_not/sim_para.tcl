...
set ::bali::simulation::Para(PROJECT) {sim_transistor_not}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/transistors}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/transistors/primitives_ex.v" "D:/RTL_FPGA/transistors/not_switch_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {not_switch_tf}
