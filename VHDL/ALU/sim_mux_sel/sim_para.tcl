...
set ::bali::simulation::Para(PROJECT) {sim_mux_sel}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VHDL/ALU}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VHDL/MUX/mux_sel.vhd" "D:/RTL_FPGA/VHDL/ALU/mux_sel_tb.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {mux_sel_tb}
