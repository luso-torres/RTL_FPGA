...
set ::bali::simulation::Para(PROJECT) {sim_reverse_bits}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VHDL/reverse_bits}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VHDL/reverse_bits/reverse_bits_function.vhd" "D:/RTL_FPGA/VHDL/reverse_bits/reverse_bits_tb.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {reverse_bits_tb}
