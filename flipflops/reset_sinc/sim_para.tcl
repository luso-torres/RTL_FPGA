...
set ::bali::simulation::Para(PROJECT) {reset_sinc}
set ::bali::simulation::Para(PROJECTPATH) {C:/FPGAprojects/flipflops}
set ::bali::simulation::Para(FILELIST) {"C:/FPGAprojects/flipflops/reset_sinc.v" "C:/FPGAprojects/flipflops/reset_sinc_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {reset_sinc_tf}
