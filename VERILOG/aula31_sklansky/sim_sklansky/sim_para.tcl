...
set ::bali::simulation::Para(PROJECT) {sim_sklansky}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/aula31_sklansky}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/aula31_sklansky/adder_sklansky.v" "D:/RTL_FPGA/VERILOG/aula31_sklansky/Sklansky_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {Sklansky_tb}
