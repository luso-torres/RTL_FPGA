...
set ::bali::simulation::Para(PROJECT) {sim_sklansky_param}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/aula31_sklansky}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/aula31_sklansky/sklansky_param.v" "D:/RTL_FPGA/VERILOG/aula31_sklansky/Sklansky_par_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {Sklansky_par_tb}
