...
set ::bali::Para(MODNAME) mux_gates
set ::bali::Para(PROJECT) mux_gates_vhdl
...
set ::bali::Para(OUTNAME) mux_gates_tb
set ::bali::Para(EXT) .vhd
set ::bali::Para(FILELIST) {"D:/RTL_FPGA/ALU/mux_gates.vhd=work" }
