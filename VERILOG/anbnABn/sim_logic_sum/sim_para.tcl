...
set ::bali::simulation::Para(PROJECT) {sim_logic_sum}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/anbnABn}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/anbnABn/logic_sum.v" "D:/RTL_FPGA/VERILOG/anbnABn/logic_sum_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {logic_sum_tf}
