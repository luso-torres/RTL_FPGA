...
set ::bali::simulation::Para(PROJECT) {sim_carry_look_ahead}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/aula18_clah}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/aula18_clah/somador_carry_look_ahead_param.v" "D:/RTL_FPGA/VERILOG/aula18_clah/carry_look_ahead_adder_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {carry_look_ahead_adder_tb}
