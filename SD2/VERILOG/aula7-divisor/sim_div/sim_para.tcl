...
set ::bali::simulation::Para(PROJECT) {sim_div}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD2/VERILOG/aula7-divisor}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD2/VERILOG/aula7-divisor/div_clock.vhd" "D:/RTL_FPGA/SD2/VERILOG/aula7-divisor/div_clk_tb.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {div_clk_tb}
