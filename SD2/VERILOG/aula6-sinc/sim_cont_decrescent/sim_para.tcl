...
set ::bali::simulation::Para(PROJECT) {sim_cont_decrescent}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD2/VERILOG/aula6-sinc}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD2/VERILOG/aula6-sinc/contador_vhdl.vhd" "D:/RTL_FPGA/SD2/VERILOG/aula6-sinc/cnt_asc_mod13_tb.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {cnt_asc_mod13_tb}
