...
set ::bali::simulation::Para(PROJECT) {sim_rad}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD2/VERILOG/aula6-sinc}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD2/VERILOG/aula6-sinc/cont_assincr.vhd" "D:/RTL_FPGA/SD2/VERILOG/aula6-sinc/cnt_asc_rand_tb.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {cnt_asc_rand_tb}
