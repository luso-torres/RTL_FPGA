...
set ::bali::simulation::Para(PROJECT) {sim_ex1}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD2/VERILOG/aula10-fsm_mealy/Ex1}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD2/VERILOG/aula10-fsm_mealy/Ex1/caracol_robotico.v" "D:/RTL_FPGA/SD2/VERILOG/aula10-fsm_mealy/Ex1/mealy_zero_detector_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {mealy_zero_detector_tf}
