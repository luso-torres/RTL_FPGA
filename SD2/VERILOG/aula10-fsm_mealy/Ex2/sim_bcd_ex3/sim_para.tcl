...
set ::bali::simulation::Para(PROJECT) {sim_bcd_ex3}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD2/VERILOG/aula10-fsm_mealy/Ex2}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD2/VERILOG/aula10-fsm_mealy/Ex2/conversor_bcd.v" "D:/RTL_FPGA/SD2/VERILOG/aula10-fsm_mealy/Ex2/conversor_bcd_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {conversor_bcd_tf}
