...
set ::bali::simulation::Para(PROJECT) {sim_media}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD2/VERILOG/aula12-fsm/Ex3}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD2/VERILOG/aula12-fsm/Ex3/media_aritmetica.v" "D:/RTL_FPGA/SD2/VERILOG/aula12-fsm/Ex3/media_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {media_tb}
