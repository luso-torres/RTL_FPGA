...
set ::bali::simulation::Para(PROJECT) {sim_siso_lr}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD2/VERILOG/aula5-reg_lr}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD2/VERILOG/aula5-reg_lr/reg_siso_N.v" "D:/RTL_FPGA/SD2/VERILOG/aula5-reg_lr/reg_siso_M.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {reg_siso}
