...
set ::bali::simulation::Para(PROJECT) {sim_mux_14}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD2/VHDL/aula3_mux_14}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD2/VHDL/aula3_mux_14/mux_case.v" "D:/RTL_FPGA/SD2/VHDL/aula3_mux_14/mux_4_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {mux_4_tf}
