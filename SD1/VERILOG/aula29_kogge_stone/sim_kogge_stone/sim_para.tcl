...
set ::bali::simulation::Para(PROJECT) {sim_kogge_stone}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/aula29_kogge_stone}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/aula29_kogge_stone/kogge_stone_sum.v" "D:/RTL_FPGA/VERILOG/aula29_kogge_stone/KoggeStone_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {KoggeStone_tb}
