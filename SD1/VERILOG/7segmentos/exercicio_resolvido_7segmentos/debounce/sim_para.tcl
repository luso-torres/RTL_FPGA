...
set ::bali::simulation::Para(PROJECT) {debounce}
set ::bali::simulation::Para(PROJECTPATH) {C:/FPGAprojects/7segmentos/exercicio_resolvido_7segmentos}
set ::bali::simulation::Para(FILELIST) {"C:/FPGAprojects/7segmentos/exercicio_resolvido_7segmentos/debounce.v" "C:/FPGAprojects/7segmentos/exercicio_resolvido_7segmentos/debounce_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {debounce_tf}
