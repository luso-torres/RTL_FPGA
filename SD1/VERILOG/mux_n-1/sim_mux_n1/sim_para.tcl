...
set ::bali::simulation::Para(PROJECT) {sim_mux_n1}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/mux_n-1}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/mux_n-1/mux_n1.v" "D:/RTL_FPGA/VERILOG/mux_n-1/mux_n1_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {mux_n1_tf}
