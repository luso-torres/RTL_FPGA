...
set ::bali::simulation::Para(PROJECT) {sim_wallace_flux}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/aula36_wallace}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/aula36_wallace/wallace_fluxo.v" "D:/RTL_FPGA/VERILOG/aula36_wallace/wallace_fluxo_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {wallace_fluxo_tf}
