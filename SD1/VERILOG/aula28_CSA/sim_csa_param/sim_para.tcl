...
set ::bali::simulation::Para(PROJECT) {sim_csa_param}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/aula28_CSA}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/aula28_CSA/CSA_param.v" "D:/RTL_FPGA/VERILOG/aula28_CSA/parameterized_csa_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {parameterized_csa_tb}
