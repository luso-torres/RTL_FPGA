...
set ::bali::simulation::Para(PROJECT) {sim_exula_8bits}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/VERILOG/aula25_ex_ula}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/VERILOG/aula25_ex_ula/impl1/source/carry_lah_4bits_behav.vhd" "D:/RTL_FPGA/VERILOG/aula25_ex_ula/exula1.v" "D:/RTL_FPGA/VERILOG/aula25_ex_ula/exula_8bits.v" "D:/RTL_FPGA/VERILOG/aula25_ex_ula/aula25_ex_ula_tf.v" }
set ::bali::simulation::Para(GLBINCLIST) {}
set ::bali::simulation::Para(INCLIST) {"none" "none" "none" "none"}
set ::bali::simulation::Para(WORKLIBLIST) {"work" "work" "work" "work" }
set ::bali::simulation::Para(COMPLIST) {"VHDL" "VERILOG" "VERILOG" "VERILOG" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {exula_8bits_tf}
