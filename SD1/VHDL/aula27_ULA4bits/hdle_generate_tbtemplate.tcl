...
set ::bali::Para(MODNAME) ULA_4bits
set ::bali::Para(PROJECT) ula4bits
...
set ::bali::Para(OUTNAME) ULA_4bits_tb
set ::bali::Para(EXT) .vhd
set ::bali::Para(FILELIST) {"D:/RTL_FPGA/VHDL/aula27_ULA4bits/ula_4bits.vhd=work" }
