...
set ::bali::Para(MODNAME) ieee754_adder
set ::bali::Para(PROJECT) ponto_flutuante
...
set ::bali::Para(OUTNAME) ieee754_adder_tb
set ::bali::Para(EXT) .vhd
set ::bali::Para(FILELIST) {"D:/RTL_FPGA/VHDL/aula33_ponto_flutuante/flutuante.vhd=work" }
