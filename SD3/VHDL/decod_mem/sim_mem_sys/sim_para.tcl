...
set ::bali::simulation::Para(PROJECT) {sim_mem_sys}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD3_files/VHDL/decod_mem}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD3_files/VHDL/decod_mem/decod_mem.vhd" "D:/RTL_FPGA/SD3_files/VHDL/decod_mem/mem_128B_tb.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {tb_mem_128B}
