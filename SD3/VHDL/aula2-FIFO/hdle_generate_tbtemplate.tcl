...
set ::bali::Para(MODNAME) fifo_NxN_buffer_barrel
set ::bali::Para(PROJECT) FIFO
...
set ::bali::Para(OUTNAME) fifo_NxN_buffer_barrel_tb
set ::bali::Para(EXT) .vhd
set ::bali::Para(FILELIST) {"D:/RTL_FPGA/SD3_files/aula2-FIFO/FIFO_barrel.vhd=work" }
