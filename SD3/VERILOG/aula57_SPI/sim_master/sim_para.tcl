...
set ::bali::simulation::Para(PROJECT) {sim_master}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD3/VERILOG/aula57_SPI}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD3/VERILOG/aula57_SPI/SPI_master.v" "D:/RTL_FPGA/SD3/VERILOG/aula57_SPI/spi_master_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {tb_spi_master}
