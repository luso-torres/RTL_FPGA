...
set ::bali::simulation::Para(PROJECT) {sim_SPI_slave}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD3/VERILOG/aula57_SPI}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD3/VERILOG/aula57_SPI/SPI_slave.v" "D:/RTL_FPGA/SD3/VERILOG/aula57_SPI/spi_slave_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {tb_spi_slave}
