...
set ::bali::simulation::Para(PROJECT) {sim_RAM_ROM}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD3}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD3/datasrc1.v" "D:/RTL_FPGA/SD3/datasrc1_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {tb_datasrc}
