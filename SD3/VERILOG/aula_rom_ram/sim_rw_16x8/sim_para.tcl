...
set ::bali::simulation::Para(PROJECT) {sim_rw_16x8}
set ::bali::simulation::Para(PROJECTPATH) {D:/RTL_FPGA/SD3}
set ::bali::simulation::Para(FILELIST) {"D:/RTL_FPGA/SD3/ram_168.v" "D:/RTL_FPGA/SD3/rw_16x8_sync_tf.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {rw_16x8_sync_tf}
